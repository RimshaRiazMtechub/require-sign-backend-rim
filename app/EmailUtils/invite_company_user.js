...
const InviteCompanyUser = (email, resetLink, company_name, subject) => {
  ...
  const mailOptions = {
    ...
    <body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
        <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">${email} via ${company_name}</div>
      ...
      <td class="sm-py-32 sm-px-24" style="mso-line-height-rule: exactly; padding: 48px; text-align: center; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
          ...
          <img src=${imageURL} width="200" alt="RS User" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0;">
                          ...
                          <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 1; margin-bottom: 10px;font-size: 16px; ">Hello ${email}, a warm welcome to ${
      company_name === null ? "RequireSign" : company_name
    }!  </p>
                            ...
                            ${
                              company_name === null
                                ? "RequireSign"
                                : company_name
                            } has invited you to join their team. Please verify your email address to get started.
                            ...
                            <table cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                <td style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px; background-color: #23b3e8; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                  <a href=${resetLink} style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">Click Here To Verify &rarr;</a>
                                </td>
                              </tr>
                            </table>
                           ...
                           NOTE: If you did not sign up please ignore this message or contact us at 
                            <a href="mailto:${
                              urls.support_email
                            }" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #2367a6; text-decoration: none;">${
      urls.support_email
    }</a>
                          </p>
                            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
...
module.exports = InviteCompanyUser;
