  ...
  const mailOptions = {
    ...
    <body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
      ...
      <div role="article" aria-roledescription="email" aria-label="Reset your Password" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
        <table style="width: 100%;margin-top: 40px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
                    ...
                    <td align="center" class="sm-px-24" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                      <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                          ...
                          <span style="font-weight:700;">  ${user_name_sender}</span> with email address <span style="font-weight:700;">${email_user}</span> has sent the document with file name,<span style="font-weight:700;"> ${title} </span>,for you to review and complete/sign.
                               </p>
                             <p>${message} </p>
...
module.exports = SendEsignEmailTemplate;
