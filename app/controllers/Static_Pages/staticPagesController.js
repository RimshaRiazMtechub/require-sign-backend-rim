...
exports.createPage = async (req, res, next) => {
    ...
    try {
        ...
        const userData = await pool.query("INSERT INTO static_pages(page_name,language,page_title,keyword,meta_description,content) VALUES($1,$2,$3,$4,$5,$6) returning *",
            [page_name,
                language,
                page_title,
                keyword,
        ...
        res.json({ error: false, data, message: "Page Created Successfully" });
...
exports.getSinglePage = async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query('SELECT * FROM static_pages WHERE page_id=$1',[
            page_id
        ]);
