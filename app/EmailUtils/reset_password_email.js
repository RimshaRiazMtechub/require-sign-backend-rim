                    ...
                    <td align="center" class="sm-px-24" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                      <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                          ...
                          <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 1; font-size: 16px; ">Hello ${first_name} ${last_name}!</p>
                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                            A request to reset password for your account with email address: 
                              <a href="mailto:${email}" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #2367a6;; text-decoration: none;">${email}</a>
                             .<br><br>
                             The link below is valid for 1 hour from that time it was sent to you and can be used to change password only once.<br><br>
If you did not request this please delete this message. To continue click link below.
                            ...
                            <table cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                <td style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px; background-color: #23b3e8; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                  <a href=${resetLink} style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">Reset Password &rarr;</a>
                                </td>
                              </tr>
                            </table>
