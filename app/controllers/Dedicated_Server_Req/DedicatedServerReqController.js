...
exports.createreq = async (req, res, next) => {
    ...
    try {
        ...
        const userData = await pool.query("INSERT INTO dedicated_server_req(company_name,company_email,contact_no,description,max_user_limit) VALUES($1,$2,$3,$4,$5) returning *",
            [company_name,
                company_email,
                contact_no,
                description,
...
exports.getAllreqs = async (req, res) => {
    const client = await pool.connect();
    try {
        const result = await pool.query('SELECT * FROM dedicated_server_req');
...
exports.deletereqs = async (req, res) => {
    ...
    try {
        ...
        const checkQuery = 'SELECT * FROM dedicated_server_req WHERE req_id = $1';
        ...
        if (checkResult.rows.length === 0) {
            ...
            const deleteQuery = 'DELETE FROM dedicated_server_req WHERE req_id = $1';
