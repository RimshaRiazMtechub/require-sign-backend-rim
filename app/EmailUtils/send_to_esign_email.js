                        ...
                        <td align="center" class="sm-px-24" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                          <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                              ...
                              <span style="font-weight:700;">  ${sender_name}</span> with email address <span style="font-weight:700;">${sender_email}</span> has sent the document with file name,<span style="font-weight:700;"> ${file_name} </span>,for you to review and complete/sign.
                                   </p>
                                 <p>${message} </p>
